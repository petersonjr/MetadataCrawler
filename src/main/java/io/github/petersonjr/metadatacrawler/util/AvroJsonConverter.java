...
// Source from:
// https://github.com/kaaproject/kaa/blob/master/common/endpoint-shared/src/main/java/org/kaaproject/kaa/common/avro/AvroJsonConverter.java
...
public class AvroJsonConverter<T extends SpecificRecordBase> {
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public String encodeToJson(T record, boolean pretty) throws IOException {
		return new String(encodeToJsonBytes(record, pretty), UTF8);
	}
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public byte[] encodeToJsonBytes(T record, boolean pretty) throws IOException {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		jsonEncoder = EncoderFactory.get().jsonEncoder(this.schema, baos, pretty);
